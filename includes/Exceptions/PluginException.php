...
class PluginException extends Exception {
     ...
     */
    public function __construct($message = '', $error_code = '', $data = [], $code = 0, Exception $previous = null) {
...
class ApiException extends PluginException {
     ...
     * @param array $data
     */
    public function __construct($message = '', $status_code = 400, $error_code = 'api_error', $data = []) {
...
class ValidationException extends PluginException {
     ...
     * @param string $message
     */
    public function __construct($validation_errors = [], $message = 'Validation failed') {
        $this->validation_errors = $validation_errors;
        parent::__construct($message, 'validation_error', ['validation_errors' => $validation_errors]);
    }
...
class DatabaseException extends PluginException {
     ...
     * @param array $data
     */
    public function __construct($message = 'Database error occurred', $data = []) {
...
class AuthenticationException extends PluginException {
     ...
     * @param array $data
     */
    public function __construct($message = 'Authentication failed', $data = []) {
...
class AuthorizationException extends PluginException {
     ...
     * @param array $data
     */
    public function __construct($message = 'Access denied', $data = []) {
...
class ConfigurationException extends PluginException {
     ...
     * @param array $data
     */
    public function __construct($message = 'Configuration error', $data = []) {
