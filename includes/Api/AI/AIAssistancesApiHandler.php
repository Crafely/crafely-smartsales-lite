...
class AIAssistancesApiHandler
{
    ...
    {
        register_rest_route('ai-smart-sales/v1', '/assistances', [
            'methods' => 'GET',
            'callback' => [$this, 'get_assistances'],
            'permission_callback' => [$this, 'check_permission'],
        ]);

        register_rest_route('ai-smart-sales/v1', '/assistances/(?P<id>\d+)', [
            'methods' => 'GET',
            'callback' => [$this, 'get_assistance'],
            'permission_callback' => [$this, 'check_permission'],
        ]);

        register_rest_route('ai-smart-sales/v1', '/assistances', [
            'methods' => 'POST',
            'callback' => [$this, 'create_assistance'],
            'permission_callback' => [$this, 'check_permission'],
        ]);

        register_rest_route('ai-smart-sales/v1', '/assistances/(?P<id>\d+)', [
            'methods' => 'PUT',
            'callback' => [$this, 'update_assistance'],
            'permission_callback' => [$this, 'check_permission'],
        ]);

        register_rest_route('ai-smart-sales/v1', '/assistances/(?P<id>\d+)', [
            'methods' => 'DELETE',
            'callback' => [$this, 'delete_assistance'],
            'permission_callback' => [$this, 'check_permission'],
        ]);
    }
    ...
    public function get_assistances($request)
    {
        ...
        $formatted_results = array_map([$this, 'format_assistance_response'], $results);
    ...
    public function create_assistance($request)
    {
        ...
        $inserted = $wpdb->insert($table_name, [
            ...
            'title' => $data['title'],
            'page' => $data['page'],
            'ai_config' => isset($data['ai_config']) ? json_encode($data['ai_config']) : null,
        ]);
    ...
    public function update_assistance($request)
    {
        ...
        $updated = $wpdb->update($table_name, [
            ...
            'ai_config' => isset($data['ai_config']) ? json_encode($data['ai_config']) : $existing_assistance['ai_config'],
        ], ['id' => $id]);
