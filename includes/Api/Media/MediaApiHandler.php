...
class MediaApiHandler {
    ...
    public function register_routes() {
        register_rest_route('ai-smart-sales/v1', '/media', array(
            'methods'  => 'GET',
            'callback' => array($this, 'get_media'),
            'permission_callback' => array($this, 'check_permission'),
        ));

        register_rest_route('ai-smart-sales/v1', '/media/(?P<id>\d+)', array(
            'methods'  => 'GET',
    ...
    public function check_permission($request) {
        ...
        $allowed_roles = ['administrator', 'csmsl_spos_outlet_manager', 'csmsl_pos_cashier', 'csmsl_pos_shop_manager'];
