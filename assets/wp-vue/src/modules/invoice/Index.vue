  ...
  <AppLayout activeRouteName="app.invoice">
    <div class="p-8" :style="{ zoom: isSmallScreen ? 0.6 : 1 }">
      <PrintSection ref="printSectionRef">
        <Card
          class="print:mb-1 print:p-1 print:border-none print:shadow-none print:bg-white print:text-black mb-4 text-base font-normal"
        >
          <CardHeader>
            <div class="flex justify-between border-b pb-2 mb-4">
              <div>
                <h1 class="text-2xl font-bold">
                  Invoice
                  <span v-if="activeInvoice" class="text-sm text-slate-400"
          ...
          <CardContent>
            ...
            <div class="flex justify-between gap-4 mb-4">
              <AddressCard
                ...
                :title="
                  ...
                  'Marchent Outlet'
                "
                :email="selectedOutlet?.email || appSettings?.email"
                :address="selectedOutlet?.address || appSettings?.store_address"
              >
                <template v-if="hasOutlet">
                  <div class="print:hidden w-full flex items-center">
                    <FormField name="outlet">
                      <FormItem :class="`w-full`">
                        <FormControl>
                          <Select v-model="invoiceForm.outlet_id">
                            <SelectTrigger>
                ...
                <template v-if="customers" class="relative">
                  ...
                  <div class="print:hidden w-full flex items-center">
                    ...
                    <Button
                      ...
                      @click="
                        activeTab =
                          activeTab === 'create' ? 'details' : 'create'
                      "
                    >
                      <PlusCircledIcon
                        :class="activeTab === 'create' && 'rotate-45'"
                        class="h-6 w-6"
                      />
                    </Button>
                  </div>
            ...
            <div class="py-2 flex justify-between">
              <div class="flex print:w-fit print:justify-between gap-4">
                <p
              ...
              <Button class="print:hidden" @click="activeTab = 'addItem'"
            ...
            <div class="flex justify-end mt-4">
              <div class="space-y-2 min-w-[300px]">
                <div class="flex justify-between">
                  ...
                  <span class="font-medium">${{ subTotalPrice }}</span>
                </div>
                <div class="flex justify-between">
                  <span class="text-sm"
                    >Vat
                    <span class="border-b-2 pb-1 overflow-hidden print:hidden">
                      (
                      <EditableText
                        :class="' inline-block'"
                        :is-number="true"
      ...
      <div class="print:hidden flex justify-center gap-2">
        ...
        /></Button>
        <Button v-if="!activeInvoice" @click="submitInvoice" :loading="loading">
          Submit <Send class="w-4 h-4 ml-2"
        /></Button>
        <Button v-if="activeInvoice" @click="updateInvoice(invoiceForm)">
          ...
          <TabsContent value="addItem" class="mt-0">
            ...
            <div class="additem w-full p-4">
              <div class="flex justify-end">
                <Button @click="activeTab = 'details'" variant="outline"
                  >Close
