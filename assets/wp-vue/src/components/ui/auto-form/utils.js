import { has, capitalize, get } from 'lodash'
/**
 * Beautify a camelCase text.
 * e.g. "myString" -> "My String"
 */
export const beautifyObjectName = (text, itemKey = 'name') => {
    if (isObject(text)) {
        if (has(text, itemKey)) {
            return beautifyObjectName(get(text, itemKey), itemKey)
        }
        return text
    }
